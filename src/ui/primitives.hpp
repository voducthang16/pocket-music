...
void strokeRect(SDL_Renderer*, const SDL_Rect&, SDL_Color);
void verticalGradient(SDL_Renderer*, const SDL_Rect&, SDL_Color, SDL_Color);
...
void drawBattery(SDL_Renderer*, int, int, int);
